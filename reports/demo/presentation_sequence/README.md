...
| `demo_navigation_oracle_counterfactual_rollout_05s.mp4` | 25-second 1080p 5-second-horizon real ViZDoom counterfactual rollout with Korean in-video labels. Five branches are restarted from the same sample pose and followed separately: recent-motion baseline, endpoint-provided upper bound, map-provided upper bound, recorded future path, and our model. |
