...
| `demo_main_5baseline_multiscenario_05s.mp4` | 49-second 1440p main 5-baseline comparison video. It concatenates a human-action replay GT block and a V4 multi-scenario ViZDoom GT block, using only CV, PointNav/DD-PPO endpoint oracle, A* pose-graph oracle, GT, and ours. Each clip explicitly marks whether the GT source is human-action replay-derived or recorded ViZDoom policy trajectory. |
