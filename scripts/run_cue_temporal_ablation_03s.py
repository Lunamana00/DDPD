"""Run the 3s cue temporal transformer retraining ablation end to end."""
...
DEFAULT_CONFIGS = [
    Path("configs/ablations/train_cue_temporal_on_03s.yaml"),
    Path("configs/ablations/train_cue_temporal_off_03s.yaml"),
]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run 3s cue temporal ablation training and summarization.")
...
def main() -> None:
    ...
    run([args.python, "scripts/summarize_cue_temporal_ablation.py"])
